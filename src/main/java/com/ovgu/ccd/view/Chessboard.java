    ...
    public void move(Square begin, Square end, boolean refresh, boolean clearForwardHistory)
    {
        ...
        if (end.getPiece().name.equals("King"))
        {
            ...
            if (begin.getPozX() + 2 == end.getPozX())
            {
                ...
                move(getSquares()[7][begin.getPozY()], getSquares()[end.getPozX() - 1][begin.getPozY()], false, false);
            ...
            {
                move(getSquares()[0][begin.getPozY()], getSquares()[end.getPozX() + 1][begin.getPozY()], false, false);
                ifWasCastling = end.getPiece();  // for undo
        ...
        {
            if (twoSquareMovedPawn != null && getSquares()[end.getPozX()][begin.getPozY()] == twoSquareMovedPawn.square) //en passant
            {
                ifWasEnPassant = getSquares()[end.getPozX()][begin.getPozY()].getPiece(); //for undo
                ...
                getSquares()[end.getPozX()][begin.getPozY()].setPiece(null);
                wasEnPassant = true;
            }
            ...
            if (end.getPiece().square.getPozY() == 0 || end.getPiece().square.getPozY() == 7) //promote Pawn
            {
                if (clearForwardHistory)
                {
                    String color;
                    if (end.getPiece().getPlayer().color == Player.colors.white)
                    {
